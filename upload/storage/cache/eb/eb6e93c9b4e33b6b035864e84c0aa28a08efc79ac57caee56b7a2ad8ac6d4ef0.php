...
/* __string_template__fafbdd3125ba6d953833011294038e4e50f971641c4adaaddd50d9be6a66fda3 */
class __TwigTemplate_93156647a3477d6f3c2c8c0e01bf47f44006cfd8face044777121171af85a79b extends Twig_Template
{
...
";
  ...
  function update(){
   ...
   \t\t\t\tif(store['address']){
   \t\t\t\t\tconsole.log('done');
   \t\t\t\t\tdocument.getElementById(\"store\").value = \"超商代碼:\"+store.route+\"店名:\"+store.name+\"地址\"+store.adress;
   \t\t\t\t\tclearInterval(id); 
   \t\t\t\t}
              },
              error: function (res) {
...
";
    ...
    {
        return "__string_template__fafbdd3125ba6d953833011294038e4e50f971641c4adaaddd50d9be6a66fda3";
    }
